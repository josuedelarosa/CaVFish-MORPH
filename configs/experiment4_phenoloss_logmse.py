# ===================================================================
# EXPERIMENT 4: PhenoLoss + LogMSE (Complete Approach)
# ===================================================================
# 
# Paper Section: Experimental Protocol - Combined Approach
# Purpose: Combines anatomical constraints with logarithmic error emphasis
# Loss Function: KeypointLogMSELoss + PhenotypeDistanceLoss
# Head Type: PhenoLossHead with both MSE transformation and phenotypic loss
# Validation: Every 300 epochs
# 
# This configuration represents the complete approach combining both
# anatomical structure constraints and relative error weighting.
# ===================================================================
...
work_dir = './work_dirs/experiment4_phenoloss_logmse'  # Training output directory
...
# Save best model based on Average Precision (AP) metric
default_hooks = dict(
...
codec = dict(
    ...
    # Alternative codec configuration (commented):
